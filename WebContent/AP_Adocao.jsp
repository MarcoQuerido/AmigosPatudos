	...
	<section class="py-2 text-center container">
    	<div class="row py-lg-5">
        	<div class="col-lg-6 col-md-8 mx-auto">
                <h1 class="fw-light">Animais para Adoção</h1>
                <p class="lead text-muted"> Nesta página pode procurar por vários animais disponíveis para adoção em Portugal e que foram aqui anunciados. 
                Para ver mais detalhes sobre um animal, basta clicar em 'Mais detalhes' por baixo da imagem.</p>
                <p>
                  <a href="InscreverParaAdocao.html" class="btn btn-primary my-2">Criar um anúncio</a>
