...
<html>
	...
	<!-- Navbar (sticky top) -->
		<div class="w3-top w3-hide-small">
			<div class="w3-bar w3-white w3-center w3-padding w3-opacity-min w3-hover-opacity-off">
				...
				<a href="Quiz.jsp" style="width:20%" class="w3-bar-item w3-button"><b>Quiz</b></a>
	...
	ResultSet resultSet = null;
	 ...
	 String sql ="SELECT * FROM perdido WHERE cod_perdido="+codigo+"";	
	 ...
	 <div class="row g-5">
      ...
      <a href="AP_Perdidos.jsp" class="btn btn-primary my-2">Voltar Atrás</a>
      </div>
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation" novalidate>
          <div class="row g-3">
            <div class="col-sm-4">
              <label for="firstName" class="form-label">Nome do dono:  </label>
              <label class="form-control"> <%=resultSet.getString("dono") %> </label>
            </div>

            <div class="col-sm-2">
              <label for="lastName" class="form-label">Telemóvel:  </label>
			...
			<div class="col-6">
              <label for="firstName" class="form-label">Tipo de animal:  </label>
              <label class="form-control"> <%=resultSet.getString("tipo") %> </label>
            </div>

            <div class="col-sm-2">
              <label for="lastName" class="form-label">Nome:</label>
              <label class="form-control"> <%=resultSet.getString("nome_animal") %> </label>
            </div>
            
            <div class="col-sm-2">
              <label for="lastName" class="form-label">Cor:</label>
              <label class="form-control"> <%=resultSet.getString("cor") %> </label>
            </div>
            ...
            <div class="col-6">
              <label for="address" class="form-label">Observações:</label>
